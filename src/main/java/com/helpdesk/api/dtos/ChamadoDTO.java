...
public class ChamadoDTO implements Serializable {
	...
	public ChamadoDTO(Chamado chamadoDTO) {
		...
		this.prioridade = chamadoDTO.getPrioridade().getCodigo();
		this.status = chamadoDTO.getStatus().getCodigo();
		this.titulo = chamadoDTO.getTitulo();
		this.observacoes = chamadoDTO.getObservacoes();
		this.tecnico = chamadoDTO.getTecnico().getId();
		this.cliente = chamadoDTO.getCliente().getId();
